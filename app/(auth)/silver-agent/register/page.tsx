...
import SilverAgentReg from "../../../../public/Silver Agent Registration.svg"


const Register = () => {
    return (
        <div className={`background-primary-silver w-full border border-black h-screen flex flex-col justify-evenly gap-10 pb-20`}>
            <Image src={SilverAgentReg}  alt="" className="w-7/12 lg:w-5/12 mt-5 mx-auto"/>
            <div className="flex flex-col gap-[30px] items-center mx-4 md:mx-6 lg:mx-10">
                ...
                <ButtomPrimary text="Register" variant="silver" />
            </div>
        </div>
    )
}
