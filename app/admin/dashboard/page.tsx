    ...
    return (
        <div className="mx-4 mt-20  h-full ">
            <div className="flex flex-row justify-between">
                ...
                <Dialog>
                    <DialogTrigger
                        className="btn-primary-admin border-2 border-black px-9 py-2 rounded-md text-xs text-black font-semibold">
                                ...
                                {admins.map((admin: UserProps) => (
                                    <TableRow key={admin._id}>
                                        <TableCell className="w-[300px]">
                                            ...
                                            {/*        </DialogHeader>*/}
                                            {/*        <LoadBalanceForm _id={admin._id} handleApi={putRequestAdminUser}/>*/}
                                            {/*    </DialogContent>*/}
                                            {/*</Dialog>*/}
                                        </TableCell>
                                ...
                                {platUsers.map((platUser: UserProps, index) => (
                                    <TableRow key={index}>
                                        <TableCell>
                                            <Dialog>
                                                <DialogTrigger
                                                    className="btn-primary-admin border-2 border-black px-4 py-1 rounded-md text-[8px] text-black font-extrabold">
                                                    Load
                                                </DialogTrigger>
                                                <DialogContent className="background-primary-plat">
                                                    <DialogHeader>
                                                    ...
                                                    <LoadBalanceForm variant="plat" parentId={linkId} _id={platUser._id}
                                                                     handleApi={putLoadPlatinumUser}/>
                                                </DialogContent>
                                            </Dialog>
                                        </TableCell>
